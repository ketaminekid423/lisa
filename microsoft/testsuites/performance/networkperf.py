...
class NetworkPerformace(TestSuite):
    ...
    def perf_ntttcp(
        ...
        try:
            ...
            for ntttcp_message in perf_ntttcp_message_list:
                ntttcp_message = dict_to_fields(information, ntttcp_message)
                ntttcp_message.test_case_name = test_case_name
                ntttcp_message.data_path = data_path
    ...
    def perf_iperf(
        ...
        for iperf3_message in iperf3_messages_list:
            iperf3_message = dict_to_fields(information, iperf3_message)
            iperf3_message.test_case_name = test_case_name
            iperf3_message.data_path = data_path
